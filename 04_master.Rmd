...
>*Answer 1:*It will saturate because the sattellite is from above so will reach a maximum  greeness. After this point the plants will be growing vertically not showing a significant change. It will then fluctuate due to seasonal fluctuation.
<br>
...
>*Answer 2:* When incorporating seasonal variation, the alpha parameter decreases by 0.04 units and has a slightly more significant p-value. The gamma parameter increased by 0.04 with no noticible change in the p-value. The lamda parameter decreases by 0.19 with a more significant p-value.
<br>
...
>*Answer 3:* Model 2 ,as the p-value is significant (<0.001) meaning we have enough evidence to reject the null hypothesis and conclude that the full model significantly reduces theresidual sum of squares and is therefore better.

Q4: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?

>*Answer 4:* There are 2 as the second model has two more parameters than the first model. 
...
>*Answer 5:* Yes, the second (full) model is preferred as the AIC is lower and therefore better decsribes the variaton without excessive parameters. It is significantly better as it's AIC value is more than 3 units than the simple models. 
